...
function Navbar() {
  ...
  <div className="navbar-nav">
         ...
         {/* <a className={"nav-link navbar-brand"} href="#footer"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-translate" viewBox="0 0 16 16">
  ...
  // <nav className={`navbar ${navbar ? "sticky" : ""} navbar-expand-lg bg-ligh`}>
  //   <h6 className="navbar-logo">DolcidiFily</h6>
  // 
